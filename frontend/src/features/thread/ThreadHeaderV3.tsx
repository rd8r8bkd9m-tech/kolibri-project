...
export function ThreadHeaderV3({ mobile = false }: { mobile?: boolean }) {
  ...
  return (
    <header className="flex shrink-0 items-center justify-between gap-3 border-b border-foreground/6 bg-background/96 px-4 py-3 backdrop-blur-sm lg:px-6">
      <div className="min-w-0">
        ...
        <h1 className="truncate text-[1rem] font-semibold tracking-[-0.03em] text-foreground">
      ...
      <div className="flex items-center gap-2">
        <Button type="button" variant="ghost" size="icon" className="h-10 w-10 rounded-full hover:bg-foreground/5" onClick={handleAddSession}>
        ...
        <Button type="button" variant="ghost" size="icon" className="h-10 w-10 rounded-full hover:bg-foreground/5" onClick={openSettings}>
