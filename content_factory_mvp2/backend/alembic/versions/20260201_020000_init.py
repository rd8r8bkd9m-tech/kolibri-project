...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("workspace_id", sa.String(), nullable=False, index=True),
        sa.Column("cms_type", sa.String(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("transcript_or_text", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("workspace_id", sa.String(), nullable=False, index=True),
        sa.Column("pillar_topic", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("seo_article_md", sa.Text(), nullable=True),
        sa.Column("faq_json", postgresql.JSONB(), nullable=True),
        sa.Column("schema_json", postgresql.JSONB(), nullable=True),
        sa.Column("internal_links_json", postgresql.JSONB(), nullable=True),
    ...
    op.create_table(
        "render_artifacts",
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("content_package_id", sa.String(), nullable=False, index=True),
        sa.Column("render_profile_id", sa.String(), nullable=False, index=True),
        sa.Column("type", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("content_package_id", sa.String(), nullable=False, index=True),
        sa.Column("channel_or_site_id", sa.String(), nullable=False),
        sa.Column("target", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("site_clicks", sa.Integer(), nullable=True),
    )
    op.create_table(
        "attributions",
        sa.Column("id", sa.String(), primary_key=True),
