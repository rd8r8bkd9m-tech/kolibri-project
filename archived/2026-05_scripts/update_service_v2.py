...
[Service]
ExecStart=/bin/bash -c "tail -f /dev/null | /root/kolibri_node --genome /root/kolibri.genome --bootstrap /root/knowledge_bootstrap.ks --listen 4050"
Restart=always
User=root
...
print("Updating systemd service with pipe to keep stdin alive...")
