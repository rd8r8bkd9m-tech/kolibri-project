...
def test_search_engine_normalizes_duckduckgo_redirect_urls():
    from backend.service.search_engine import _normalize_web_url

    raw = "//duckduckgo.com/l/?uddg=https%3A%2F%2Fru.wikipedia.org%2Fwiki%2F%D0%A0%D0%B8%D0%BC%D1%81%D0%BA%D0%BE%D0%B5_%D0%BF%D1%80%D0%B0%D0%B2%D0%BE&amp;rut=test"
    normalized = _normalize_web_url(raw)

    assert normalized.startswith("https://ru.wikipedia.org/wiki/")
    assert "duckduckgo.com/l/" not in normalized
